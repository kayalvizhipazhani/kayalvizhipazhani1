...
var wpAjaxUrl='https://opticalshop.info/wp-admin/admin-ajax.php';var flBuilderUrl='https://opticalshop.info/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://opticalshop.info/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://opticalshop.info/wp-admin/admin-ajax.php'},breakpoints:{small:767,medium:1024},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery('p').each(function(){var $this=jQuery(this);if($this.html().replace(/\s|&nbsp;/g,'').length==0)
$this.remove();});jQuery(document).ready(function($){jQuery.validator.addMethod("lettersspaceonly",function(d,e){return this.optional(e)||/^[a-zA-Z\s\-]+$/i.test(d);},"Letters only please");});document.addEventListener('wpcf7submit',function(){setTimeout(function(){jQuery('.wpcf7-response-output').slideUp();},5000);});(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-5db6bd97b5989 .pp-heading-separator, .fl-node-5db6bd97b5989 .pp-heading').removeClass('pp-left');$('.fl-node-5db6bd97b5989 .pp-heading-separator, .fl-node-5db6bd97b5989 .pp-heading').addClass('pp-tablet-');}
if($(window).width()<=480){$('.fl-node-5db6bd97b5989 .pp-heading-separator, .fl-node-5db6bd97b5989 .pp-heading').removeClass('pp-left');$('.fl-node-5db6bd97b5989 .pp-heading-separator, .fl-node-5db6bd97b5989 .pp-heading').addClass('pp-mobile-');}})(jQuery);(function($){FLBuilderPostGrid=function(settings)
...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5db6bdc80a024',layout:'columns',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);