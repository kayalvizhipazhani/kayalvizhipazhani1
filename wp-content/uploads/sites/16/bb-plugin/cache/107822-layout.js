...
$this.remove();});jQuery(document).ready(function($){jQuery.validator.addMethod("lettersspaceonly",function(d,e){return this.optional(e)||/^[a-zA-Z\s\-]+$/i.test(d);},"Letters only please");});document.addEventListener('wpcf7submit',function(){setTimeout(function(){jQuery('.wpcf7-response-output').slideUp();},5000);});(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-5da712e04fb29 .pp-heading-separator, .fl-node-5da712e04fb29 .pp-heading').removeClass('pp-left');$('.fl-node-5da712e04fb29 .pp-heading-separator, .fl-node-5da712e04fb29 .pp-heading').addClass('pp-tablet-left');}
if($(window).width()<=480){$('.fl-node-5da712e04fb29 .pp-heading-separator, .fl-node-5da712e04fb29 .pp-heading').removeClass('pp-left');$('.fl-node-5da712e04fb29 .pp-heading-separator, .fl-node-5da712e04fb29 .pp-heading').addClass('pp-mobile-left');}})(jQuery);